...
-- tbl_categoria
CREATE
OR REPLACE TABLE tbl_categoria (
...
-- tbl_proveedor
CREATE
OR REPLACE TABLE tbl_proveedor (
	id int NOT NULL AUTO_INCREMENT,
...
-- tbl_comentarios
CREATE
OR REPLACE TABLE tbl_comentarios (
	id int NOT NULL AUTO_INCREMENT,
...
VALUES
	('Aro Luz', '40000', 'Aro para selfie', 1, 1);
